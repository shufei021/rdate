...
function getWeekByDate(n){
	...
	if(i===n){
		return arguments[1]?dateToStandard(arguments[1]):dateFormat('yyyy-MM-dd',new Date())
	}else if(i===0){
		switch(n){
			case 1:
		...
		switch(n){
			case 1:
			return getBeAfDateByDate(i-1)
			case 2:
			return getBeAfDateByDate(i-2)
			case 3:
			return getBeAfDateByDate(i-3)
			case 4:
			return getBeAfDateByDate(i-4)
			case 5:
			return getBeAfDateByDate(i-5)
			case 6:
			return getBeAfDateByDate(i-6)
			case 0:
			return getBeAfDateByDate(i-7)
		}
	}
}
