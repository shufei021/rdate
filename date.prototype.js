...
Date.prototype.isLeapYear=function(){
    var y=arguments[0]?arguments[0]:this.getFullYear();
...
Date.prototype.isValidateDateTime=function(dateTime){
 	...
 	return this.isValidDate(zf)&&this.isValidTime(zs);
}
...
Date.prototype.getWeekByDate=function(n){
	var i=arguments[1]?new Date(arguments[1]).getDay():this.getDay();
	if(i===n){
		return arguments[1]?this.dateToStandard(arguments[1]).split(' ')[0]:this.dateFormat('yyyy-MM-dd',this);
	}else if(i===0){
		switch(n){
			case 1:
			return arguments[1]?this.getBeAfDateByDate(-6,arguments[1]):this.getBeAfDateByDate(-6);
			case 2:
			return arguments[1]?this.getBeAfDateByDate(-5,arguments[1]):this.getBeAfDateByDate(-5);
			case 3:
			return arguments[1]?this.getBeAfDateByDate(-4,arguments[1]):this.getBeAfDateByDate(-4);
			case 4:
			return arguments[1]?this.getBeAfDateByDate(-3,arguments[1]):this.getBeAfDateByDate(-3);
			case 5:
			return arguments[1]?this.getBeAfDateByDate(-2,arguments[1]):this.getBeAfDateByDate(-2);
			case 6:
			return arguments[1]?this.getBeAfDateByDate(-1,arguments[1]):this.getBeAfDateByDate(-1);
		}
	}else if(i===1){
		switch(n){
			case 2:
		...
		switch(n){
			case 1:
			return arguments[1]?this.getBeAfDateByDate(1-i,arguments[1]):this.getBeAfDateByDate(1-i);
			case 2:
			return arguments[1]?this.getBeAfDateByDate(1-i,arguments[1]):this.getBeAfDateByDate(2-i);
			case 3:
			return arguments[1]?this.getBeAfDateByDate(1-i,arguments[1]):this.getBeAfDateByDate(3-i);
			case 4:
			return arguments[1]?this.getBeAfDateByDate(1-i,arguments[1]):this.getBeAfDateByDate(4-i);
			case 5:
			return arguments[1]?this.getBeAfDateByDate(1-i,arguments[1]):this.getBeAfDateByDate(5-i);
			case 6:
			return arguments[1]?this.getBeAfDateByDate(1-i,arguments[1]):this.getBeAfDateByDate(6-i);
			case 0:
			return arguments[1]?this.getBeAfDateByDate(1-i,arguments[1]):this.getBeAfDateByDate(7-i);
		}
	}
};
...
Date.prototype.getWeekNumOfYear=function(date){
	...
	return Math.ceil((this.getDateDiff(date1,date2)+1)/7);
};
